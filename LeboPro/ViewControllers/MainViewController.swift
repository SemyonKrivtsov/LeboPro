...
class MainViewController: UIViewController {
    ...
    private let userNameTF = CustomTextFieild(textColor: .black, textAlignment: .left, placeholder: "Имя пользователя", isSecureTextEntry: false, returnKeyType: .next)
...
extension UINavigationBar {
    open override func sizeThatFits(_ size: CGSize) -> CGSize
    {
        ...
        let newSize = CGSize(width: frame.size.width, height: barHeight)
